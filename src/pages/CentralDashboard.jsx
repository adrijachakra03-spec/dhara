                  ...
                  <div className="border-b border-[var(--line)] p-5 sm:p-6">
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                      ...
                      <div className="flex shrink-0 flex-col items-start lg:items-end">
                        ...
                        <span className="mt-1 inline-flex items-center gap-1.5 font-mono text-[10px]">
                          <ShieldCheck size={12} />
                  ...
                  <div className="flex flex-col gap-4 border-t border-[var(--line)] bg-[var(--paper)] p-4 sm:flex-row sm:items-center sm:justify-between sm:px-5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono text-[9px] uppercase tracking-[0.1em] text-[var(--ink-soft)]">
                        Review state clearance and national oversight record
                      </span>
                    </div>
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-3 border border-[var(--ink)] bg-[var(--ink)] px-5 py-3 font-mono text-[10px] uppercase tracking-[0.14em] text-[var(--paper)] transition hover:border-[var(--earth)] hover:bg-[var(--earth)]"
                    >
                      Review project
                      <ArrowRight size={14} />
                    </button>
